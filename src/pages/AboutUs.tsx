      ...
      <section className="pt-2 pb-14 sm:pt-0 sm:pb-20 bg-background">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center max-w-4xl">
          ...
          <p className="text-muted-foreground text-lg sm:text-xl mb-8">
            Have a question about our products or your delivery? We're just a message away. Reach out directly on WhatsApp for the fastest response.
          </p>
          <a
            href="https://wa.me/9110380467"
            target="_blank"
            rel="noreferrer"
