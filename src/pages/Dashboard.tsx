...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative -mt-16 md:-mt-20 pt-16 md:pt-20 bg-gradient-to-br from-[#1f5a42] via-[#2f7656] to-[#5a9d6f] text-white min-h-[100svh] md:min-h-[100dvh] flex items-center overflow-hidden">
